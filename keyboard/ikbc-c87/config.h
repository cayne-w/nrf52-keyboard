...
#define MANUFACTURER "IKBC" /* 硬件制造商，用于USB和蓝牙显示 */
#define PRODUCT "IKBC_C87" /* 硬件名称，用于USB和蓝牙显示 */
...
// 多用途 Bootloader 按钮
// #define NRF_BL_DFU_MULTI_ROLE_BTN 2

// USB UART 传输配置
// #define HAS_USB // 启用与CH554的通信支持
// #define UART_RXD 22 // UART_RX口IO
// #define UART_TXD 23 // UART_TX口IO
...
static const uint8_t row_pin_array[MATRIX_ROWS] = { 15, 14, 13, 20, 19, 18, 17, 16 };
static const uint8_t column_pin_array[MATRIX_COLS] = { 11, 12, 26, 8, 25, 6, 5, 4, 3, 31, 30, 29, 28, 27, 9, 7 };
